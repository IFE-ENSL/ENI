        ...
        public void Validate()
        {
            ...
            if (nbrPers == 5)
            {
                if (globalSatisfaction.satisfactionGlobale < 60)
                {
                    ...
                    GameObject.FindGameObjectWithTag("CharacterSheetManager").GetComponent<CharacterSheetManager>().AddQualityStep(compGenToAddPoint, 1, "mini-jeu 02");
                ...
                else if (globalSatisfaction.satisfactionGlobale < 80)
                {
                    ...
                    GameObject.FindGameObjectWithTag("CharacterSheetManager").GetComponent<CharacterSheetManager>().AddQualityStep(compGenToAddPoint, 2, "mini-jeu 02");
                }
                else if (globalSatisfaction.satisfactionGlobale > 80)
                {
                    _pieceRobot.Bras = (int)TypePieceRobot.Or;
                    GameObject.FindGameObjectWithTag("CharacterSheetManager").GetComponent<CharacterSheetManager>().AddQualityStep(compGenToAddPoint, 3, "mini-jeu 02");
                }
